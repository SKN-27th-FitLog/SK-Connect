...
from common.constant import ThreadPrefix
...
def run_pipeline() -> None:
    ...
    last_geek = get_last_success_date_by_thread_prefix(ThreadPrefix.GEEKNEWS)
    last_pt = get_last_success_date_by_thread_prefix(ThreadPrefix.PYTORCH)
