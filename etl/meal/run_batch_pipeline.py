...
def main():
    ...
    parser.add_argument("--dbname", default=os.environ.get("SERVICE_DB_NAME", "service"), help="DB Name")
    parser.add_argument("--user", default=os.environ.get("DB_USER", "user"), help="DB User")
    parser.add_argument("--password", default=os.environ.get("DB_PASSWORD", "password123"), help="DB Password")
