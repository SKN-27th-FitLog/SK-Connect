...
def route_by_keyword(state: ChatbotState) -> str:
    ...
    elif keyword == "weather_agent":
        node_name = 'create_agent_by_weather'
    elif keyword == "news_agent":
...
def create_chatbot_graph(is_checkpointer:bool=True):
    ...
    # 연결 앳지  
    workflow.add_edge('create_keyword_node', 'chatbot_node')
    workflow.add_edge('create_keyword_node', 'create_coding_node')
    workflow.add_edge('create_keyword_node', 'create_cooking_node')
    workflow.add_edge('create_keyword_node', 'create_agent_by_weather')
    workflow.add_edge('create_keyword_node', 'create_agent_by_news')
    workflow.add_edge('create_keyword_node', 'create_agent_by_stock')
