...
def response_from_graph(user_msg:str, model:str=LLM_NM.ollama.name):
    '''
    ...
    # 채팅 그래프 실행 
    state = chat_graph.invoke({'messages': [HumanMessage(content=user_msg)], 'model': model}, config=config)
